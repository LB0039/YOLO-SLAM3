...
public:
    ...
    void SetYoloResults(vector<cv::Rect2i> &result, int i);
    void RemoveOutliers(const cv::Mat &imGray, const cv::Mat &imDepth, const double &timeStamp, 
    ...
    void Remove_Moving_KeyPoints(std::vector<cv::KeyPoint> kps, const cv::Mat &imGray, const cv::Mat &imDepth,
